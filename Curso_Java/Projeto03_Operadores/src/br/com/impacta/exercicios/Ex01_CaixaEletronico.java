...
public class Ex01_CaixaEletronico {
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "O valor do seu saque será R$: " + valor + pulaLinha +
				"Você receberá: " 				+ pulaLinha +
				"Notas de R$ 50,00: " 		+ qtde50 + pulaLinha +
				"Notas de R$ 20,00: " 		+ qtde20 + pulaLinha +
				"Notas de R$ 10,00: " 		+ qtde10 + pulaLinha +
				"Notas de R$ 5,00: " 		+  qtde5 + pulaLinha);
	}
}
