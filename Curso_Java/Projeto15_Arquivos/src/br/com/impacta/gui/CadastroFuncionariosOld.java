...
public class CadastroFuncionarios extends JFrame {
	...
	public CadastroFuncionarios() {
				...
				try {
					...
					while(true) { // Responsável por linha a linha do arquivo
						...
						Funcionario f = new Funcionario(
								itens[0], // Representa os nomes
								Integer.parseInt(itens[1]), //Idade
								itens[2].equals("MASCULINO") ? Sexo.MASCULINO : Sexo.FEMININO, //Sexo
								itens[3].length() == 11 ? new DocumentoCpf(itens[3]) : new DocumentoCnpj(itens[3]), //Documento CPF ou CNPJ
								itens[4], // Cargo
								Double.parseDouble(itens[5])); // Salário
		...
		JComboBox<Funcionario> cmbFuncionario1 = new JComboBox();
		cmbFuncionario1.setBounds(394, 179, 146, 22);
		panel.add(cmbFuncionario1);
